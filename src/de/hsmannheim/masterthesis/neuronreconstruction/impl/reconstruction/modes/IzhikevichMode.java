...
/**
 * Reconstruction mode with a parameter set based on the parameter sets by the
 * preceding theses.
 * 
 * This is the most restricted parameter set which results in the fastest
 * reconstruction.
 * 
 * <p />
 * a &nbsp;&nbsp;∈ [0.01, 0.1]<br />
 ...
 * @author Leah Lackner
 */
public class IzhikevichMode extends ReconstructionModeAbstract {

	private static final double MIN_A = 0.01;
	private static final double MAX_A = 0.1;

	private static final double MIN_B = 0.05;
	...
	private static final double MIN_P2 = 5;
	private static final double MAX_P2 = 5;

	private static final double MIN_P3 = 140;
	private static final double MAX_P3 = 140;
