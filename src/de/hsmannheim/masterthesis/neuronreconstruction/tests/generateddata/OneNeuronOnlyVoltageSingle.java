 ...
 * @author Leah Lackner
 */
public class OneNeuronOnlyVoltageSingle {

	public static final String DATASET_NAME = OneNeuronOnlyVoltageSingle.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronOnlyVoltageSingle.class.getSimpleName();
