 ...
 * @author Leah Lackner
 */
public class OneNeuronOnlyVoltageOverall {

	public static final String DATASET_NAME = OneNeuronOnlyVoltageOverall.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronOnlyVoltageOverall.class.getSimpleName();
