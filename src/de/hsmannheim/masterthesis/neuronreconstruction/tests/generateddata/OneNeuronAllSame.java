 ...
 * @author Leah Lackner
 */
public class OneNeuronAllSame {

	public static final String DATASET_NAME = OneNeuronAllSame.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronAllSame.class.getSimpleName();
