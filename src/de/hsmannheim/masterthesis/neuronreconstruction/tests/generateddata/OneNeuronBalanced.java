 ...
 * @author Leah Lackner
 */
public class OneNeuronBalanced {

	public static final String DATASET_NAME = OneNeuronBalanced.class.getSimpleName();
	...
	public static final double MUTATION_RATE = 0.35;
	...
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronBalanced.class.getSimpleName();
