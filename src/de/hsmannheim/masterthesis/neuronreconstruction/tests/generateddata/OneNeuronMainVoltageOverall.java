 ...
 * @author Leah Lackner
 */
public class OneNeuronMainVoltageOverall {

	public static final String DATASET_NAME = OneNeuronMainVoltageOverall.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronMainVoltageOverall.class.getSimpleName();
