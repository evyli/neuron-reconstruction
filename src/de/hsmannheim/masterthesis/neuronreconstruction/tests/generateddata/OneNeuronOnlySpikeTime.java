 ...
 * @author Leah Lackner
 */
public class OneNeuronOnlySpikeTime {

	public static final String DATASET_NAME = OneNeuronOnlySpikeTime.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronOnlySpikeTime.class.getSimpleName();
