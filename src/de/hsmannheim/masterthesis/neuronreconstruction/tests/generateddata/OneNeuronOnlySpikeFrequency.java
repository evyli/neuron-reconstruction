 ...
 * @author Leah Lackner
 */
public class OneNeuronOnlySpikeFrequency {

	public static final String DATASET_NAME = OneNeuronOnlySpikeFrequency.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronOnlySpikeFrequency.class.getSimpleName();
