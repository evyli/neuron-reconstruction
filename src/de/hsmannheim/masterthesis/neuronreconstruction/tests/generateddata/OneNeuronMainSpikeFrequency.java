 ...
 * @author Leah Lackner
 */
public class OneNeuronMainSpikeFrequency {

	public static final String DATASET_NAME = OneNeuronMainSpikeFrequency.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronMainSpikeFrequency.class.getSimpleName();
