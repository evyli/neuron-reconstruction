 ...
 * @author Leah Lackner
 */
public class OneNeuronMainSpikeTime {

	public static final String DATASET_NAME = OneNeuronMainSpikeTime.class.getSimpleName();
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronMainSpikeTime.class.getSimpleName();
