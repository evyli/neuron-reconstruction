 ...
 * @author Leah Lackner
 */
public class OneNeuronAllSameShortRunning {

	public static final String DATASET_NAME = OneNeuronAllSameShortRunning.class.getSimpleName();
	...
	public static final int GENERATION_THRESHOLD = 35;
	...
	public static final String OUTPUT_PATH = "generatedData/" + OneNeuronAllSameShortRunning.class.getSimpleName();
