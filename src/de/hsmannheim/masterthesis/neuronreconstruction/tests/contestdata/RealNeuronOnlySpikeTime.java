 ...
 * @author Leah Lackner
 */
public class RealNeuronOnlySpikeTime {

	public static final String DATASET_NAME = RealNeuronOnlySpikeTime.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronOnlySpikeTime.class.getSimpleName();
