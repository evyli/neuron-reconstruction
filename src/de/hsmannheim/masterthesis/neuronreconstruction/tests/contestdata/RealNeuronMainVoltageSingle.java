 ...
 * @author Leah Lackner
 */
public class RealNeuronMainVoltageSingle {

	public static final String DATASET_NAME = RealNeuronMainVoltageSingle.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronMainVoltageSingle.class.getSimpleName();
