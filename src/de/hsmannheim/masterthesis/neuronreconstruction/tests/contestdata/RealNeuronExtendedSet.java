 ...
 * contest using the extended parameter set. (the details can be found in the README.md file)
 * 
 * @author Leah Lackner
 */
public class RealNeuronExtendedSet {

	public static final String DATASET_NAME = RealNeuronExtendedSet.class.getSimpleName();
	...
	public static final int GENERATION_THRESHOLD = 1;
	...
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronExtendedSet.class.getSimpleName();

	public static final ReconstructionMode RECONSTRUCTION_MODE = ReconstructionMode.IZHIKEVICH_EXTENDED;
