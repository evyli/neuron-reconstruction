 ...
 * @author Leah Lackner
 */
public class RealNeuronMainVoltageOverall {

	public static final String DATASET_NAME = RealNeuronMainVoltageOverall.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronMainVoltageOverall.class.getSimpleName();
	...
	public static void main(String[] args) throws IOException {
		...
		spikeMeasures.put(VoltageOverallQualityMeasure.class, 5.0);
