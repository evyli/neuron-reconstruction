 ...
 * @author Leah Lackner
 */
public class RealNeuronAllSame {

	public static final String DATASET_NAME = RealNeuronAllSame.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronAllSame.class.getSimpleName();
