 ...
 * @author Leah Lackner
 */
public class RealNeuronOnlyVoltageSingle {

	public static final String DATASET_NAME = RealNeuronOnlyVoltageSingle.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronOnlyVoltageSingle.class.getSimpleName();
