 ...
 * @author Leah Lackner
 */
public class RealNeuronOnlyVoltageOverall {

	public static final String DATASET_NAME = RealNeuronOnlyVoltageOverall.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronOnlyVoltageOverall.class.getSimpleName();
