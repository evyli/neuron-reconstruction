 ...
 * @author Leah Lackner
 */
public class RealNeuronOnlySpikeFrequency {

	public static final String DATASET_NAME = RealNeuronOnlySpikeFrequency.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronOnlySpikeFrequency.class.getSimpleName();
