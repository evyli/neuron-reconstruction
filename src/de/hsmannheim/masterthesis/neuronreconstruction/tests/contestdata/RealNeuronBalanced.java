...
/**
 * This is a test for a reconstruction using the neuron data from the contest
 * using the extended parameter set. (the details can be found in the README.md
 * file)
 * 
 * @author Leah Lackner
 */
public class RealNeuronBalanced {

	public static final String DATASET_NAME = RealNeuronBalanced.class.getSimpleName();
	...
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronBalanced.class.getSimpleName();
