 ...
 * @author Leah Lackner
 */
public class RealNeuronMainSpikeFrequency {

	public static final String DATASET_NAME = RealNeuronMainSpikeFrequency.class.getSimpleName();
	public static final String OUTPUT_PATH = "contestdata-output/" + RealNeuronMainSpikeFrequency.class.getSimpleName();
	...
	public static void main(String[] args) throws IOException {
		...
		spikeMeasures.put(SpikeFrequencyQualityMeasure.class, 5.0);
